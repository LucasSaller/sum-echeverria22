...
// Genera el array de páginas con "..." donde corresponde.
// Ejemplo con 10 páginas y página actual 5: [1, "...", 4, 5, 6, "...", 10]
            ...
            {shown.map((booking) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="sm:hidden flex items-center justify-between gap-2 min-w-0">
                    ...
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        {/* Mobile: dpto + date + turn in one line */}
                  ...
                  {/* ── Desktop columns (hidden on mobile via sm:block) ── */}
                  {/* Name + avatar — desktop only */}
